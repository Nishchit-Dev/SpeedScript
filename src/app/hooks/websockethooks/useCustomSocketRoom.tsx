          ...
          switch (message.type) {
            ...
            case "room_state":
              setRoomData({
                ...
                data: {
                  ...
                  text: message.data.text || "Default typing text",
                  startTime: message.data.startTime,
                  totalCharacters: message.data.totalCharacters,
            ...
            case "admin_wpm_update":
              setFinalLeaderboard((prevFinalLeaderboard) => {
                const updatedLeaderboard = prevFinalLeaderboard.map(
                  (leaderboard) => {
                    const updatedPlayerWpmData =
                      leaderboard.data.playerWpmData.map((player) => {
                        if (roomData.data.players[player.username]) {
                          return {
                            ...player,
                            wpm: roomData.data.players[player.username].wpm,
                          };
                        }
                        return player;
                      });
                    return {
                      ...
                      data: {
                        ...leaderboard.data,
                        playerWpmData: updatedPlayerWpmData,
                      },
                    };
                  }
                );
            ...
            case "player_kicked":
              ...
              setRoomData((prevRoomData) => {
                ...
                delete updatedPlayers[message.data.kicked_player];
                return {
                  ...prevRoomData,
                  data: {
                    ...prevRoomData.data,
                    players: updatedPlayers,
                    currentPlayers: prevRoomData.data.currentPlayers - 1,
                  },
                };
              });
              break;
