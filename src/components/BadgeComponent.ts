export function getBadgeImage(wpm: number): string {
    ...
    if (wpm >= 9 && wpm <= 19) return 'Badge_02.svg' // Learner
    if (wpm >= 19 && wpm <= 29) return 'Badge_03.svg' // Rookie
    if (wpm >= 29 && wpm <= 39) return 'Badge_04.svg' // Improver
    if (wpm >= 39 && wpm <= 59) return 'Badge_05.svg' // Proficient
    if (wpm >= 59 && wpm <= 69) return 'Badge_06.svg' // Skilled
    if (wpm >= 69 && wpm <= 89) return 'Badge_07.svg' // Expert
    if (wpm >= 89 && wpm <= 109) return 'Badge_08.svg' // Ace
