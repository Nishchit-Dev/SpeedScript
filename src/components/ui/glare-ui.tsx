...
export const GlareCard = ({
    ...
    const containerStyle = {
        ...
        '--glare-color': '#4ADE80', // New variable for glare color
    } as any
    ...
    return (
        <div
            ...
            className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-min rounded-xl "
            ref={refElement}
            onPointerMove={(event) => {
